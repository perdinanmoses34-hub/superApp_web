...
export default function InstallPrompt() {
  ...
  useEffect(() => {
    ...
    const handleBeforeInstallPrompt = (e: Event) => {
      ...
      // Store event to be triggered when user clicks the Install button
              ...
              <div className="space-y-4">
                ...
                <div className="bg-gradient-to-br from-teal-50/50 to-emerald-50/20 p-4 rounded-2xl border border-teal-100/60">
                  ...
                  <ol className="list-decimal pl-4 text-[10px] text-gray-600 space-y-1.5 font-medium leading-relaxed">
                    ...
                    <li>Pilih opsi <strong className="text-teal-700">"Instal Aplikasi"</strong> (pilih 'Instal Aplikasi' agar terpasang sebagai aplikasi Android penuh tanpa logo Chrome dan tanpa bar link).</li>
                    <li>Ketuk <strong className="text-teal-700">"Instal"</strong> pada dialog konfirmasi Android yang muncul.</li>
                    <li>Aplikasi CMS akan terpasang di HP Anda dengan ikon mandiri dan tampilan layar penuh (fullscreen)!</li>
                  </ol>
                </div>
